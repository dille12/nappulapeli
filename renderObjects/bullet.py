...
class Bullet(DemoObject):
    def __init__(self, weapon, pos, angle, spread = 0.1, damage = 10, rocket = False, type = "normal", piercing = False, homing = False, critChance = 0, id=None):
        ...
        super().__init__(demo_keys=("pos", "trail"), id = id)
        if self.app.DO_DEMO:
            self.logCreation(Bullet, args, {"id": self.id})
