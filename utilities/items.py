...
def getItems():
    ...
    return [
        create_item("Timbsit", speedMod=["mult", 1.5]),
        ...
        create_item("Romupanssari", defenceNormal=["mult", 1.5], speedMod=["mult", 0.85]),
        create_item("Cryo-puku", defenceEnergy=["mult", 2], speedMod=["mult", 0.8]),
        ...
        create_item("Adderall", weaponHandling=["mult", 2], speedMod=["mult", 1.25], weaponReload=["mult", 0.75], healthCapMult=["mult", 0.5]),
        create_item("Dodge Charger", dodgeChance=["add", 0.2], speedMod=["mult", 1.2]),
        ...
        create_item("Kelan työttömyysturva", xpMult=["mult", 5], weaponHandling=["mult", 0.5], speedMod=["mult", 0.6]),
        ...
        create_item("Paholaisien munat", saveChance=["add", -0.1], healthCapMult=["mult", 0.8], speedMod=["add", 0.2], weaponDamage=["add", 0.25]),
        ...
        create_item("Latexpuku", defenceEnergy=["mult", 1.4], speedMod=["mult", 0.85]),
        ...
        create_item("Tankki", speedMod=["mult", 0.5], healthCapMult=["mult", 2]),
        ...
        create_item("Paskahousu", shitChance=["add", 0.025], speedMod=["mult", 0.9], healthCapMult=["mult", 1.1]),
        ...
        create_item("Taktinen juoksu", tacticalSprintSpeed=["mult", 2]),
