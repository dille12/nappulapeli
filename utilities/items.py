...
def getItems():
    ...
    return [
        ...
        create_item("Sotasaalis", xpMult=["add", 0.25]),
        create_item("Raskas sarja", xpMult=["add", 0.5], tripChance=["add", 0.01]),
        create_item("Kaaleet", meleeDamage=["add", 0.5], tripChance=["add", 0.01]),
        ...
        create_item("Kivimies", tripChance=["add", 0.01], defenceNormal=["mult", 2], defenceEnergy=["mult", 2], defenceExplosion=["mult", 2]),
